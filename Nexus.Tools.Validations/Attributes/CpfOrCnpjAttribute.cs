...
namespace Nexus.Tools.Validations.Attributes
{
  ...
  public sealed class CpfOrCnpjAttribute : ValidationAttribute
  {
    public CpfOrCnpjAttribute()
    {
      ...
      this.ErrorMessageResourceName = "CpfOrCnpjValidation";
    }
    ...
    public override bool IsValid(object value)
    {
      ...
      if (this.CPFOnly)
      {
        if (this.ErrorMessageResourceName != null && this.ErrorMessageResourceType != (Type) null && this.ErrorMessageResourceName == "CpfOrCnpjValidation" && this.ErrorMessageResourceType.FullName == typeof (Errors).FullName)
          this.ErrorMessageResourceName = "CpfValidation";
        return CpfOrCnpjAttribute.IsCpf(str);
      }
      if (this.CNPJOnly)
      {
        if (this.ErrorMessageResourceName != null && this.ErrorMessageResourceType != (Type) null && this.ErrorMessageResourceName == "CpfOrCnpjValidation" && this.ErrorMessageResourceType.FullName == typeof (Errors).FullName)
          this.ErrorMessageResourceName = "CnpjValidation";
